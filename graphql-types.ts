...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___codegenConfig___hooks___afterGenerate'
...
export type SitePluginPluginOptionsCodegenConfig = {
  hooks?: Maybe<SitePluginPluginOptionsCodegenConfigHooks>;
};

export type SitePluginPluginOptionsCodegenConfigFilterInput = {
  hooks?: Maybe<SitePluginPluginOptionsCodegenConfigHooksFilterInput>;
};

export type SitePluginPluginOptionsCodegenConfigHooks = {
  afterGenerate?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsCodegenConfigHooksFilterInput = {
  afterGenerate?: Maybe<StringQueryOperatorInput>;
};
...
export type BlogPostsPageQuery = { allContentfulBlogPost: { edges: Array<{ node: (
        ...
        & { body?: Maybe<Pick<ContentfulBlogPostBodyTextNode, 'body'>>, image?: Maybe<{ file?: Maybe<Pick<ContentfulAssetFile, 'url'>> }> }
      ) }> } };
...
export type BlogPageQuery = { contentfulBlogPost?: Maybe<(
